...
version_added: '1.1.0'
short_description: Get Azure Host Group Details
description:
    - Get Azure Host Group Details.
options:
    resource_group:
        description:
...
EXAMPLES = '''
    - name: Get Azure Host Group Details.
...
class AzureRMHostGroupInfo(AzureRMModuleBaseExt):
    def __init__(self):
        ...
        super(AzureRMHostGroupInfo, self).__init__(derived_arg_spec=self.module_arg_spec,
    ...
    def exec_module(self, **kwargs):
        ...
        changed = True
        response = self.get_host_group_info()
    ...
    def get_host_group_info(self):
        # self.log('Get Host Group Details {0}'.format(self.))
        try:
            ...
            self.log('Error in fetching Azure Host Group Details.')
            self.fail('Error in fetching Azure Host Group Details {0}'.format(str(e)))
